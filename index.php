...
<html>
	...
	<body>
			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						<li>
							<a href="./auth/register.php"><span class="glyphicon glyphicon-user"></span> Sign in</a>
						</li>
						<li>
							<a href="./auth/log.php"><span class="glyphicon glyphicon-user"></span> Log in</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="container" role="main">
			<div class="jumbotron">
				<p> <strong> Welcome to land sarvay project.</strong> Visit your desire page and find your desire service.</p>
			</div>
		</div>
